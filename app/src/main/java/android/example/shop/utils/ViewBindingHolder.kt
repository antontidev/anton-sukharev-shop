/**
 * Found this at https://android.jlelse.eu/viewbinding-in-fragments-the-clean-easy-way-2f0ce68aee22
 * Interesting thing, but it has strange behavior. Then i subclassing my Fragment after [ViewBindingHolderImpl]
 * and then using [this] inside any method, android studio says that my Fragment is the object of [ViewBindingHolderImpl] type
 */
